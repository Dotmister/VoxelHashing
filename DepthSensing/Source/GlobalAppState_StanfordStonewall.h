...
std::string GlobalAppState::s_ImageReaderSesnorSourcePath = "../stanfordData/stonewall_png/";
unsigned int GlobalAppState::s_ImageReaderSesnorNumFrames = 2700;
...
float GlobalAppState::s_virtualVoxelSize = 0.004;
...
float GlobalAppState::s_SensorDepthWorldMax = 6.0f;
