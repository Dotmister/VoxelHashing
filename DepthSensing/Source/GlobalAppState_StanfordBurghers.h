...
std::string GlobalAppState::s_ImageReaderSesnorSourcePath = "../stanfordData/burghers_png/";
unsigned int GlobalAppState::s_ImageReaderSesnorNumFrames = 11230;
...
float GlobalAppState::s_virtualVoxelSize = 0.006;
...
float GlobalAppState::s_StreamingRadius = 4.0f; // Depends on DepthMin and DepthMax
...
float GlobalAppState::s_maxIntegrationDistance = 3.0f;
